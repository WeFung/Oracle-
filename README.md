...
！！！注意！！！仅首次检测到OCI CLI残留文件会执行命令删除的，避免安装冲突！！！所以要是不想运行这条命令可以删除，但是你OCI的目录要按照它脚本的路径来，不然影响到后面运行

![immwrt界面](https://github.com/user-attachments/assets/073c59a0-c23e-4c5a-8a51-10585758b404)
...
！！！以上的信息要打开脚本，以文档txt或者其他工具编译，然后把里面的信息填写到相应的位置上,其余信息
...
最后脚本运行成功与正常，可以登录自己甲骨文的审计里的日志对比一下脚本创建实例的时间与你日志的是否一致，由于中国的时间是UTC+8，所以要把你电脑的实际时间再减去8，就与甲骨文的时间一致了

![immwrt界面](https://github.com/user-attachments/assets/aae929f0-0028-4ceb-a6b1-0e4b02afc123)


![immwrt界面](https://github.com/user-attachments/assets/ffdf0296-1f4d-45a0-bf66-a5219f82a19e)
